...
function loadStartupConfig(options = {}) {
  ...
  const config = {
    ...
    botLogsChannelName: env.DISCORD_BOT_LOGS_CHANNEL_NAME || "bot-logs",
    botLogsChannelId: optionalSnowflakeValues.DISCORD_BOT_LOGS_CHANNEL_ID,
